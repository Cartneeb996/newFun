...
namespace newFun
{
    class screenControl
    {
        ...
        // public static int controlWidth = startupForm.ActiveForm.Width;
        //public static int controlHeight = startupForm.ActiveForm.Height;

        public static int controlWidth = Screen.PrimaryScreen.WorkingArea.Width;
        public static int controlHeight = Screen.PrimaryScreen.WorkingArea.Height;
        ...
        public static Point startCentre = new Point(0, 0);
